...
Nesta análise, + representa um gate OR e . representa um gate AND. Assim, para a árvore geral:
...
Como não existem dados reais de operação para o sistema, os valores de **Severidade**, **Probabilidade** e **Detecção** foram atribuídos de forma qualitativa, usando uma escala de 1 a 10.
...
A tabela seguinte apresenta o **top 20% dos modos de falha com maior RPN**, ou seja, os eventos mais críticos identificados nas FTAs. A tabela FMEA completa, com todos os modos de falha analisados, encontra-se no **Apêndice A**.

| Componente                        | Modo de falha                                                        | Efeito                                                                                                    | Causa                                                                | Severidade | Probabilidade | Detecção | RPN | Ação recomendada                                                              |
| --------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ---------- | ------------- | -------- | --- | ----------------------------------------------------------------------------- |
| Processamento de perceção         | [A021] Mau tempo                                                     | Obstáculos ou limites da via podem ser detetados incorretamente, levando a trajetória insegura ou colisão | Chuva, nevoeiro, baixa visibilidade ou condições ambientais adversas | 10         | 5             | 5        | 250 | Validar a perceção com múltiplos sensores antes de enviar informação ao VC    |
| Processamento de perceção         | [A024] Falha no algoritmo de perceção                                | Obstáculos ou limites da via podem ser interpretados incorretamente                                       | Erro de software, modelo incompleto ou cenário não previsto          | 10         | 4             | 6        | 240 | Testar o algoritmo com cenários adversos e casos limite                       |
| Processamento de perceção         | [A022] Ruído nos sensores                                            | O sistema pode detetar objetos falsos ou ignorar objetos reais                                            | Interferência, leituras instáveis ou ruído ambiental                 | 9          | 5             | 5        | 225 | Aplicar filtragem de ruído e comparação entre sensores                        |
| PredMaint / política de segurança | [C062] Dados incertos não são classificados como situação mais grave | O platoon pode continuar a operar quando deveria entrar em modo seguro                                    | Política fail-safe inexistente ou mal definida                       | 10         | 3             | 7        | 210 | Classificar situações incertas ou incompletas como mais graves                |
| PlatMgmt                          | [A091] Dados desatualizados                                          | O líder pode manter uma visão incorreta do estado do platoon                                              | Mensagens antigas, atraso de atualização ou timestamp expirado       | 10         | 4             | 5        | 200 | Rejeitar dados com timestamp expirado antes de atualizar o estado do platoon  |
| Validação de sensores             | [B012] Ausência de dados não é detetada                              | O VC pode usar informação inexistente como válida                                                         | Timeout inexistente ou condição de ausência de dados mal definida    | 10         | 3             | 6        | 180 | Definir timeout para dados de sensores e marcar dados ausentes como inválidos |
| VC                                | [B014] Decisões com dados inválidos não são bloqueadas               | O VC pode calcular comandos com base em perceção inválida                                                 | Falta de condição de bloqueio ou fallback no VC                      | 10         | 3             | 6        | 180 | Bloquear decisões quando a perceção estiver inválida                          |
| Processamento de perceção         | [A023] Erro de calibração                                            | A posição de obstáculos ou limites da via pode ficar incorreta                                            | Calibração incorreta ou desvio após uso                              | 9          | 4             | 5        | 180 | Implementar validação periódica da calibração dos sensores                    |
| Validação de perceção             | [B021] Comparação entre sensores falha                               | Informação incorreta pode ser aceite como válida                                                          | Erro na lógica de fusão ou comparação entre sensores                 | 10         | 3             | 6        | 180 | Validar a fusão de sensores com testes específicos                            |
| VC                                | [B024] Informação incorreta é enviada ao VC                          | O VC pode tomar uma decisão insegura com base em dados errados                                            | Falha no filtro ou validação antes do envio ao VC                    | 10         | 3             | 6        | 180 | Rejeitar dados inconsistentes antes de os enviar ao VC                        |
| VC / validação de movimento       | [B044] Medições incoerentes não são rejeitadas                       | O VC pode gerar comandos inseguros de aceleração, travagem ou direção                                     | Falta de regra de rejeição de incoerências                           | 10         | 3             | 6        | 180 | Rejeitar medições incoerentes antes do cálculo de controlo                    |
| PredMaint                         | [B061] Regra de classificação mal definida                           | Uma avaria crítica pode ser tratada como não crítica                                                      | Critérios de severidade incorretos ou incompletos                    | 10         | 3             | 6        | 180 | Rever as regras de classificação de severidade                                |
| PredMaint                         | [B062] Falha no algoritmo                                            | A severidade da avaria pode ser classificada incorretamente                                               | Erro de implementação ou caso crítico não previsto                   | 10         | 3             | 6        | 180 | Testar o algoritmo com casos críticos e dados incompletos                     |
| COMM / líder                      | [C063] Líder não é informado                                         | O platoon pode não reagir a uma condição crítica                                                          | Falha no envio ou tratamento da notificação ao líder                 | 10         | 3             | 6        | 180 | Garantir notificação obrigatória ao líder em condições críticas ou incertas   |
| PlatMgmt                          | [B084] Seguidor não é marcado como não fiável                        | O líder pode continuar a confiar num veículo sem comunicação válida                                       | Falha na gestão do estado do seguidor                                | 10         | 3             | 6        | 180 | Marcar o seguidor como não fiável após timeout de comunicação                 |
| PlatMgmt / validação              | [B091] Timestamps não são verificados                                | Mensagens antigas podem ser aceites como atuais                                                           | Ausência de validação temporal                                       | 10         | 3             | 6        | 180 | Verificar timestamps antes de atualizar a visão do platoon                    |
| Atuadores                         | [B101] Confirmação dos atuadores não é recebida                      | Uma falha na execução de comando crítico pode não ser detetada                                            | Mecanismo de confirmação ausente ou com falha                        | 10         | 3             | 6        | 180 | Exigir confirmação após comandos críticos de direção, travagem ou powertrain  |

Os modos de falha com maior RPN estão concentrados na perceção, validação de dados, classificação de avarias, comunicação com o líder e confirmação dos atuadores. Isto mostra que os principais riscos não estão apenas nas falhas técnicas iniciais, mas também na ausência de deteção, validação ou reação segura perante essas falhas.

### Apendice A - Tabela FMEA

| Componente | Modo de falha | Efeito | Causa | Severidade | Probabilidade | Detecção | RPN | Ação recomendada |
|------------|---------------|--------|-------|------------|---------------|----------|-----|------------------|
| Sensores de perceção              | [A011] Falha de sensor                                        | Dados de perceção ficam indisponíveis ou incompletos       | Avaria física, alimentação instável ou degradação do sensor | 9          | 4             | 3        | 108 | Detetar ausência de dados e avisar o VC                      |
| Sensores de perceção              | [A012] Câmara obstruída                                       | O veículo pode não detetar obstáculos ou limites da via    | Sujidade, chuva, objeto a bloquear a lente                  | 9          | 5             | 3        | 135 | Adicionar verificação de visibilidade/obstrução da câmara    |
| Sensores de perceção              | [A013] Falha do LiDAR                                         | Redução da capacidade de deteção de obstáculos             | Avaria do LiDAR, desalinhamento ou alimentação instável     | 9          | 3             | 4        | 108 | Validar LiDAR com câmara e ultrassons                        |
| Sensores de perceção              | [A014] Falha de cablagem                                      | Perda de dados entre sensores e ECU                        | Cabo danificado, conector solto ou vibração                 | 8          | 3             | 4        | 96  | Adicionar diagnóstico de ligação e inspeção de cablagem      |
| ECU / entrada de sensores         | [A015] Falha de entrada na ECU                                | Dados dos sensores não chegam corretamente ao VC           | Falha de interface ou porta de entrada da ECU               | 9          | 3             | 5        | 135 | Validar entradas da ECU e gerar erro quando não houver dados |
| Validação de sensores             | [B011] Verificação automática dos sensores falha              | A ausência de dados pode não ser detetada                  | Erro na lógica de diagnóstico dos sensores                  | 10         | 3             | 5        | 150 | Testar a verificação automática dos sensores                 |
| Validação de sensores             | [B012] Ausência de dados não é detetada                       | O VC pode usar informação inexistente como válida          | Timeout ou condição de ausência de dados mal definida       | 10         | 3             | 6        | 180 | Definir timeout e estado inválido para dados ausentes        |
| VC                                | [B013] VC não é avisado                                       | O VC continua a tomar decisões sem perceção válida         | Falha na comunicação interna entre diagnóstico e VC         | 10         | 3             | 5        | 150 | Garantir notificação obrigatória ao VC                       |
| VC                                | [B014] Decisões com dados inválidos não são bloqueadas        | Comandos podem ser calculados com base em dados inválidos  | Falta de condição de bloqueio/fallback no VC                | 10         | 3             | 6        | 180 | Bloquear decisões quando a perceção estiver inválida         |
| Processamento de perceção         | [A021] Mau tempo                                              | Deteção incorreta de obstáculos ou limites da via          | Chuva, nevoeiro ou baixa visibilidade                       | 10         | 5             | 5        | 250 | Validar perceção com sensores redundantes                    |
| Processamento de perceção         | [A022] Ruído nos sensores                                     | Objetos podem ser detetados incorretamente                 | Interferência, leituras instáveis ou ruído ambiental        | 9          | 5             | 5        | 225 | Filtrar ruído e comparar sensores                            |
| Processamento de perceção         | [A023] Erro de calibração                                     | Posição de objetos/limites pode ficar incorreta            | Calibração incorreta ou desvio após uso                     | 9          | 4             | 5        | 180 | Implementar validação periódica de calibração                |
| Processamento de perceção         | [A024] Falha no algoritmo de perceção                         | Classificação ou deteção errada de obstáculos              | Erro de software/modelo ou caso não previsto                | 10         | 4             | 6        | 240 | Testar algoritmo com cenários adversos                       |
| Validação de perceção             | [B021] Comparação entre sensores falha                        | Informação incorreta pode ser aceite                       | Erro na lógica de fusão/comparação de sensores              | 10         | 3             | 6        | 180 | Validar a fusão de sensores com testes                       |
...
| VC                                | [B024] Informação incorreta é enviada ao VC                   | VC pode tomar decisão insegura                             | Falha no filtro antes do envio ao VC                        | 10         | 3             | 6        | 180 | Rejeitar dados inconsistentes antes do envio                 |
| Localização                       | [A031] Erro de GPS                                            | Posição do veículo pode ser estimada incorretamente        | Erro do recetor GPS ou erro de sinal                        | 8          | 4             | 4        | 128 | Comparar GPS com movimento do veículo                        |
...
| Localização                       | [A033] Inconsistência com o mapa                              | Rota ou posição pode ser incoerente                        | Mapa desatualizado ou erro de correspondência               | 8          | 3             | 5        | 120 | Validar posição com mapa e sensores                          |
| Localização                       | [A034] Falha no algoritmo de localização                      | Posição calculada fica errada                              | Erro de software ou fusão incorreta de dados                | 9          | 3             | 6        | 162 | Testar algoritmo de localização com cenários limite          |
...
| NAV / PlatMgmt                    | [B033] Dados de movimento recentes não são usados             | Sistema perde fallback quando GPS não é fiável             | Fallback não implementado ou não ativado                    | 8          | 3             | 5        | 120 | Ativar fallback com dados recentes                           |
...
| Validação de movimento            | [B041] Verificação de limites falha                           | Medições impossíveis podem ser aceites                     | Limites mal definidos ou não aplicados                      | 9          | 3             | 5        | 135 | Definir limites aceitáveis para velocidade/direção           |
...
| Veículo / diagnóstico             | [A051] Problema na pressão dos pneus                          | Veículo pode operar com aderência/estabilidade reduzida    | Perda de pressão ou furo                                    | 8          | 4             | 4        | 128 | Monitorizar pressão em cada ciclo                            |
| Veículo / diagnóstico             | [A052] Temperatura anormal do motor                           | Risco de degradação ou falha do powertrain                 | Sobreaquecimento ou falha de arrefecimento                  | 8          | 3             | 4        | 96  | Monitorizar temperatura e gerar aviso                        |
...
| Veículo / diagnóstico             | [A054] Falha física do veículo                                | Veículo pode continuar com condição insegura               | Falha mecânica ou elétrica não especificada                 | 9          | 3             | 5        | 135 | Executar diagnóstico periódico completo                      |
...
| PredMaint                         | [B052] Falta de dados de diagnóstico                          | PredMaint não consegue avaliar o veículo                   | Sensores de diagnóstico indisponíveis                       | 9          | 4             | 4        | 144 | Gerar erro quando faltarem dados de diagnóstico              |
...
| PredMaint                         | [B054] Verificações periódicas não detetam a falha            | Falha permanece ativa sem mitigação                        | Período de verificação inadequado ou regra incompleta       | 9          | 3             | 6        | 162 | Rever periodicidade e regras de diagnóstico                  |
...
| PredMaint                         | [B063] Dados desatualizados                                   | Classificação pode ser baseada em estado antigo            | Timestamp expirado ou atraso nos dados                      | 9          | 4             | 5        | 180 | Rejeitar dados desatualizados                                |
...
| Validação de diagnóstico          | [C061] Valores dos sensores não são verificados               | Dados inválidos podem alimentar a classificação            | Falha na verificação de plausibilidade                      | 10         | 3             | 6        | 180 | Verificar valores contra limites esperados                   |
...
| COMM / líder                      | [C063] Líder não é informado                                  | Platoon não reage à condição crítica                       | Falha de envio/notificação ao líder                         | 10         | 3             | 6        | 180 | Informar líder em qualquer condição crítica/incerta          |
...
| COMM                              | [A071] Atraso na rede                                         | Estado de avaria chega tarde ao líder                      | Latência elevada na comunicação                             | 8          | 5             | 3        | 120 | Definir limite máximo de atraso                              |
...
| COMM                              | [A073] Congestionamento de comunicação                        | Mensagens críticas podem sofrer atraso                     | Excesso de tráfego V2V/ECU                                  | 8          | 4             | 4        | 128 | Priorizar mensagens críticas                                 |
| ECU                               | [A074] Sobrecarga da ECU                                      | Processamento/envio de mensagens pode atrasar              | Carga elevada ou tarefas concorrentes                       | 8          | 3             | 5        | 120 | Monitorizar carga e priorizar tarefas críticas               |
...
| COMM / PlatMgmt                   | [B073] Tempo máximo de receção não está definido              | Sistema não sabe quando assumir perda de informação        | Requisito temporal incompleto                               | 9          | 3             | 6        | 162 | Definir tempo máximo de receção                              |
| PlatMgmt                          | [B074] Líder não assume perda de informação                   | Decisão de paragem pode ser atrasada                       | Fallback não implementado                                   | 9          | 3             | 6        | 162 | Assumir perda de informação quando o limite é excedido       |
| COMM                              | [A081] Falha de comunicação                                   | Mensagem do seguidor não chega ao líder                    | Falha no canal V2V                                          | 9          | 4             | 4        | 144 | Monitorizar ligação V2V                                      |
...
| ECU de comunicação                | [A084] Falha da ECU de comunicação                            | Seguidor deixa de comunicar o estado                       | Falha de hardware/software na ECU                           | 9          | 3             | 5        | 135 | Monitorizar saúde da ECU de comunicação                      |
| COMM                              | [B081] Mensagens periódicas de presença falham                | Perda de comunicação pode não ser detetada                 | Heartbeat não implementado ou falha                         | 9          | 3             | 5        | 135 | Enviar mensagens periódicas de presença                      |
| COMM                              | [B082] ACK não é recebido ou processado                       | Sistema não confirma receção de mensagens críticas         | Falha no mecanismo de ACK                                   | 9          | 3             | 5        | 135 | Usar ACK obrigatório para mensagens críticas                 |
...
| PlatMgmt                          | [B085] Estado do platoon não é atualizado                     | Visão do platoon fica incompleta                           | Falha de atualização após perda de comunicação              | 10         | 3             | 6        | 180 | Atualizar estado do platoon após falha de comunicação        |
...
| PlatMgmt                          | [A092] Dados atribuídos ao veículo errado                     | Estado de um veículo pode ser aplicado a outro             | Erro de identificação/origem                                | 10         | 3             | 6        | 180 | Validar origem e ID da mensagem                              |
...
| VC                                | [A101] Falha no VC                                            | Comando de paragem/controlo pode não ser gerado ou enviado | Falha de software no VC                                     | 10         | 3             | 5        | 150 | Monitorizar execução do VC e usar fallback                   |
| ECU do atuador                    | [A102] Falha na ECU do atuador                                | Atuador pode não executar o comando                        | Falha de hardware/software na ECU                           | 10         | 3             | 5        | 150 | Diagnosticar ECU do atuador                                  |
...
| Powertrain                        | [A106] Falha no powertrain                                    | Veículo pode não reduzir/ajustar movimento corretamente    | Avaria no powertrain                                        | 9          | 2             | 5        | 90  | Monitorizar feedback do powertrain                           |
...
| VC                                | [B103] Sistema não repete o comando                           | Falha temporária pode permanecer sem recuperação           | Lógica de repetição não implementada                        | 10         | 3             | 5        | 150 | Repetir comando quando não houver confirmação                |
